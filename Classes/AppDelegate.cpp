...
static cocos2d::Size largeResolutionSize = cocos2d::Size(1920, 1030);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("BouncyHouse", Rect(0, 0, largeResolutionSize.width, largeResolutionSize.height));
